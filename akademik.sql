...
LOCK TABLES `data_kelas_detail` WRITE;
...
LOCK TABLES `data_matakuliah` WRITE;
...
LOCK TABLES `master_dosen_pengampu` WRITE;
...
LOCK TABLES `master_matakuliah` WRITE;
...
LOCK TABLES `master_prodi` WRITE;
...
LOCK TABLES `master_tingkat` WRITE;
...
LOCK TABLES `master_ujian_jawaban` WRITE;
...
LOCK TABLES `master_ujian_soal` WRITE;
...
LOCK TABLES `ujian_jawaban` WRITE;
...
LOCK TABLES `ujian_peserta` WRITE;
...
LOCK TABLES `ujian_peserta_jawaban` WRITE;
...
LOCK TABLES `ujian_session` WRITE;
...
-- Dump completed on 2022-07-29 13:49:06
